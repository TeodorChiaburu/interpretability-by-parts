...
log_dir = os.path.join("log", args['save'])
check_dir = os.path.join("checkpoints")
tensorboard_dir = os.path.join("tensorboard_log", args['save'])
...
def main():
    ...
    # wrap to dataset
    train_data = iNat3_mini(root=data_dir, train=True, transform=train_transforms)
    test_data = iNat3_mini(root=data_dir, train=False, transform=test_transforms)
